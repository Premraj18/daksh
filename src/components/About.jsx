        ...
        <section className="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800 ">
            <motion.div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6 hidden sm:block">
                <div className="flex flex-wrap ">
                    ...
                    <motion.div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                        <motion.div className="pl-4 mb-6 border-l-4 border-lime-600 ">
                        ...
                        <motion.p className="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400">
