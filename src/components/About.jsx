...
const About = () => {
    const ref = useRef()
  return (
    <section className="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800 " ref={ref}>
    <motion.div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6"
        variants={variants}
        initial='initial'
        whileInView='animate'
    >
